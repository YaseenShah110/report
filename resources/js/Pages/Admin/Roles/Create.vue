    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-xl font-bold text-slate-900 dark:text-white">Create New Role</h2>
            </div>
        </template>
            ...
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                <form @submit.prevent="submit" class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                    ...
                    <div class="px-6 py-4 bg-slate-50 dark:bg-slate-900/50 border-t border-slate-200 dark:border-slate-700 flex gap-3">
                        <Link :href="route('admin.roles.index')" class="flex-1 px-4 py-2 border border-slate-200 dark:border-slate-600 rounded-xl text-center">Cancel</Link>
