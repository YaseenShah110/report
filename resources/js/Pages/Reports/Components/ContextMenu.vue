      ...
      >
        <template v-for="(item, idx) in items" :key="idx">
          ...
          >
            ...
            <kbd v-if="item.shortcut" class="context-shortcut">{{ item.shortcut }}</kbd>
          </button>
        </template>
      </div>
    </Transition>
...
/* Transition */
.context-enter-active { animation: contextIn 0.12s ease; }
.context-leave-active { animation: contextIn 0.1s ease reverse; }
