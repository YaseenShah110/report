<!--
  ╔══════════════════════════════════════════════════════════════════╗
  ║   ShortcutOverlay - Keyboard Shortcuts Display                  ║
  ╚══════════════════════════════════════════════════════════════════╝
-->
<template>
  <Teleport to="body">
    <div class="shortcut-backdrop" @click="$emit('close')">
      <div class="shortcut-dialog" @click.stop>
        <div class="shortcut-header">
          ...
          <button @click="$emit('close')" class="shortcut-close">
        ...
        <div class="shortcut-footer">
          Press <kbd>?</kbd> or <kbd>Ctrl</kbd>+<kbd>/</kbd> to toggle this overlay
        </div>
      </div>
    </div>
  </Teleport>
...
const shortcutGroups = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { label: 'Nudge 1px', keys: ['Arrow Keys'] },
