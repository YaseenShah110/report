...
on editor whan an element eg text,chart,list etc are select from the left item list the all their properties should be shown in the right side bar and should be editable. when the properties are edited the changes should be reflected in the canvas in real time. on left side bar under setting there should be all possilbe settings required whhile report generation like page size, orientation, background color, primary color,footer,footer size,header,header ,page number,page number possition,page margin,padding , font family etc. when these settings are changed the changes should be reflected in the canvas in real time. there should be a option to add new page and duplicate or delete existing page. when a page is selected all the elements of that page should be shown in the canvas and should be editable. there should be an option to export the report in pdf format.report should be auto saved in every 30s seconds and there should be an option to manually save the report. there should be an option to preview the report in new tab. there should be an option to change the status of the report like draft, review, final etc. 

use modern styles and also use animations and transiransion to buttons ,etc 

make the report more proffesional and mordern design ui.